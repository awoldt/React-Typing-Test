  ...
  return (
    <Container>
      ...
      <p style={{ maxWidth: "800px" }}>
        Speed typing tests measure the accuracy of words typed per minute. After
        60 seconds, a user&apos;s WPM is calculated based on the amount of correct
        words typed divided by total words typed all within the timeframe.
      </p>
      ...
      <p style={{ maxWidth: "800px" }}>
        ...
        rought estiamate of how fast a user&apos;s typing skills are. The higher a
        WPM score, the more words a user can type.
      </p>
